...
int main(int argc, char* argv[]){
	...
	faiss::IndexHNSWFlat faiss_index = build_hnsw_index(database_IDs, database_data, delim, num_elements);
	cout << "Running search..." << endl;
	search_hnsw(faiss_index, k, database_IDs, query_IDs, query_data, num_q_samples, num_elements, delim);	
