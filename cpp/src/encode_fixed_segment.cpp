...
void write_SMF_pos(int chrm_idx,
	...
	float start_bp = all_bp_positions[0];
	float end_bp = all_bp_positions.back();
	float segment_range = end_bp - start_bp;
