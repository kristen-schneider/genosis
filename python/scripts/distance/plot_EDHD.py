...
def get_args():
    ...
    parser = argparse.add_argument('--ed')
    parser = argparse.add_argument('--hd')
    parser = argparse.add_argument('--png')
...
def plot_ed_hd(ed_dict, hd_dict, png):
    ...
    png_title = 'Euclidean distance vs Hamming distance\n'
                'for binary haolotype encodings\n' \
                'on 1 cm segments\n (Segmnet 0, CHR 8)'
