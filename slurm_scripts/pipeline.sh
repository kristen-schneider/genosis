...
#SBATCH --output=/Users/krsc0813/precision-medicine/slurm_scripts/out/example.out
#SBATCH --error=/Users/krsc0813/precision-medicine/slurm_scripts/err/example.err
