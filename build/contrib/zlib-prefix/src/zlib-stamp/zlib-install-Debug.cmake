...
set(stdout_log "/home/sdp/PercisionMedicine/build/contrib/zlib-prefix/src/zlib-stamp/zlib-install-out.log")
set(stderr_log "/home/sdp/PercisionMedicine/build/contrib/zlib-prefix/src/zlib-stamp/zlib-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/sdp/PercisionMedicine/build/contrib/zlib-prefix/src/zlib-stamp/zlib-install-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "zlib install command succeeded.  See also /home/sdp/PercisionMedicine/build/contrib/zlib-prefix/src/zlib-stamp/zlib-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
