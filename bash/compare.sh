...
queries_file="/home/sdp/pmed-local/data/EUR/EUR_sample_IDs.txt"
...
$bin_dir"plink-genome" $out_dir"plink.1kg-chr8.genome.genome" $k $out_dir"topk_genome.out" $queries_file
